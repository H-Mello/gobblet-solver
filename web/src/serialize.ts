...
// v1 = strictly larger, opponent only; stuck → skip turn.
// v2 = strictly larger, any owner; stuck → skip turn.
// v3 = strictly larger, any owner; stuck → immediate draw (current rule).
